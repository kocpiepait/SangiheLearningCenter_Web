...
export default function ProgramList({ programlist }) {
  return (
    <div className="w-full h-max flex flex-col gap-4">
      {programlist.data.map((data, index) => (
        <div
          key={index}
          className="w-full bg-white p-3 flex flex-col items-center rounded-3xs [backdrop-filter:blur(17px)] border-[1px] border-solid border-whitesmoke-300 font-inter"
        >
          <div className="w-full flex flex-row items-center justify-between gap-3">
            <div className="w-[400px] h-max rounded-3xs overflow-hidden ">
              <img
            ...
            <div className="w-full flex flex-col items-start justify-center gap-4">
              <p className="cursor-pointer text-darkslateblue-300 font-medium">
                {data.nama_program}
              </p>
              <div className="flex flex-row gap-3 items-center">
                <img src="/vector/Symbol.png" alt="" />
                <p className="text-sm text-slategray m-0">
              ...
              <div className="flex flex-row gap-4">
                ...
                <div className="flex flex-col items-start m-0">
                  <p className="m-0 text-darkslateblue-300 font-medium">
                    {data.pengajar.nama_pengajar}
                  </p>
                  <p className="m-0  text-slategray">{data.pengajar.status}</p>
                </div>
              </div>
            </div>
    ...
    //                 <div className="relative leading-[21px]">Pengajar</div>
    //               </div>
    //             </div>
    //           </div>
